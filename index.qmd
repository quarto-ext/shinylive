---
title: Shiny for Python components in Quarto
format: html
filters:
  - shinylive
---
...
To display the code editor with live running Shiny app, use a code block with `{shinylive-python}`.
...
Shiny app running in an iframe, without an editor panel.
...
## Components that use Pyodide but not Shinylive

The components below don't use Shinylive, but they do use the Shinylive codebase to load Pyodide and run Python code in the browser.
